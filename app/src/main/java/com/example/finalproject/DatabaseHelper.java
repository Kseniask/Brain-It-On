...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_TASK = "create table "+TABLE_NAME_TASKS+" ("+ TASK_ID+ " INTEGER PRIMARY KEY AUTOINCREMENT, "+ TITLE+" TEXT NOT NULL, "+ DESCRIPTION +" TEXT, " +
